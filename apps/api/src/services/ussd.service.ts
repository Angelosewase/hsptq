...
export async function handleUssdRequest(sessionId: string, phoneNumber: string, text: string) {
  ...
  switch (session.currentStep) {
    case "HOME": {
      if (patient) {
        if (!patient.pin) {
          responseText = "CON Welcome to HospTQ. Please set a 4-digit PIN for future access:";
          nextStep = "SET_PIN";
        } else {
          responseText = "CON Welcome to HospTQ. Please enter your 4-digit PIN:";
          nextStep = "LOGIN_PIN";
        }
      } else {
        responseText = "CON Welcome to HospTQ. Please enter your full name to register:";
    ...
    case "REGISTER_ID": {
      ...
      responseText = "CON Registration successful.\n1. Check-in\n2. Check Status";
      nextStep = "MAIN_MENU";
      break;
    }
    ...
    case "SELECT_DEPARTMENT": {
      ...
      if (deptId && patient) {
        ...
        responseText = "END Invalid department selection. Please try again later.";
        nextStep = "END";
      }
      break;
    }
